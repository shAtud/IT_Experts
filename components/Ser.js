...
const Ser = props =>{
    ...
    return(
        <div 
          className='border-2  h-[100vh]  w-full md:w-[100%] font-fontom bg-[#F7FAFB] flex flex-col space-y-8' 
          id='services_section'
          >
          <div className='ml-12 text-6xl  text-[#5C4CFC]'>Services</div>
            <div className=" flex flex-row flex-wrap space-x-12 justify-center">
                    {comp.map((el,index)=>{
                        return(
