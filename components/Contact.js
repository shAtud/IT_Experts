const Contact = ({id}) =>{
    return(
        <div id={id} className='lg:h-[100vh] h-[100vh] bg-[#F7FAFB] w-[100%] flex flex-col-reverse lg:flex-row font-fontom   items-center justify-center'>
        <div className='flex flex-col basis-3/4 items-center justify-center border-2 '>
          <div className='pt-16 ml-12 text-6xl text-[#5C4CFC]'>Contactez-nous :</div>
